    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(null==sessionBean){
            ...
            if(StringHelper.isNotNullOrEmpty(ticket)) {
                ...
                classMap.put("data", SessionBean.class);
                classMap.put("data", SessionBean.class);
                SessionBean ssoSession = JsonHelper.json2Obj(sessionInfo, SessionBean.class);
                if(null!=ssoSession) {
                    _logger.info("【秒杀系统检票处】用户:{}手中通票{}跟sso服务验票大厅中的票匹配，允许通过",sessionBean.getUserName(), ticket);
